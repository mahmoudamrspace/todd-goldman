      ...
      <div className={"framer-xtuow"} data-framer-name={"Container"}>
        <div className={"framer-10h6ty7"} data-framer-name={"Wrapper"}>
          ...
          <HiddenReveal variant="intro-character" className={"framer-1vmc01k"} data-framer-name={"Character"} style={{"willChange": "transform", "opacity": "0", "transform": "translateY(50px) scale(0.5)"}}>
            <div className={"ssr-variant hidden-g5y12p"}>
              <div data-framer-component-type={"SVG"} data-framer-name={"Character svg"} data-framer-shadows className={"framer-1d6m6vo"} aria-hidden={true} style={{"imageRendering": "pixelated", "flexShrink": "0"}}>
