              ...
              <div className={"framer-ijjr0j"} data-framer-name={"Content"}>
                ...
                <div className={"framer-bnx3m7-container"} data-framer-name={"Menu Items"}>
                  <div className={"framer-WwdNp framer-1gc058m framer-v-1gc058m"} data-framer-name={"Default"} data-highlight={true} tabIndex={0} style={{"--1o1r33v": "16px", "--frfhbi": "center"}}>
                    <HiddenReveal className={"framer-p33yb2 framer-rqn908"} data-framer-name={content.nav[0]?.label ?? "Works"} data-highlight={true} href={content.nav[0]?.href ?? "/#works"} style={{"willChange": "transform", "opacity": "0", "transform": "translateY(20px)"}}>
                    ...
                    <HiddenReveal className={"framer-2bu14n framer-rqn908"} data-framer-name={content.nav[1]?.label ?? "About"} data-highlight={true} href={content.nav[1]?.href ?? "/#about"} style={{"willChange": "transform", "opacity": "0", "transform": "translateY(20px)"}}>
                    ...
                    <HiddenReveal className={"framer-18y0jlw framer-rqn908"} data-framer-name={content.nav[2]?.label ?? "Contact"} data-highlight={true} href={content.nav[2]?.href ?? "/#contact"} style={{"willChange": "transform", "opacity": "0", "transform": "translateY(20px)"}}>
