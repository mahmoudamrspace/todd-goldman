...
function desktopRowClass(activeIndex: number | null | undefined, index: number) {
  const base = "todd-services__tablet-10 todd-services__tablet todd-layout__utility-001";
...
export function Services({
  ...
  return (
    <section className={cn(TODD.services.section, "todd-intro__wrapper-25")} data-todd-name={"Services"}>
      <ServicesContainer>
        <div className={cn(TODD.services.container, "todd-intro__wrapper-8")} data-todd-name={"Wrapper"}>
          <div className={cn(TODD.services.title, "todd-services__title")} data-todd-name={"Title"}>
            <div className={"todd-services__tablet-3"} data-todd-component-type={"RichTextContainer"} style={{"transform": "none"}}>
              <h2 className={"todd-text todd-intro-headline__h2"} data-styles-preset={"RGebQr53Z"} dir={"auto"} style={{"--todd-text-color": "var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237))"}}>
                <AnimatedSpan variant="services" y={10}>{content.title}</AnimatedSpan>
              </h2>
            </div>
            <div className={responsiveHiddenOn("mobile")}>
              <div className={"todd-services__scribble"} data-todd-name={"Scribble"} style={{"transform": "translate(-50%, -50%)"}}>
            ...
            <div className={responsiveVisibleOnly("mobile")}>
              <div className={"todd-services__scribble"} data-todd-name={"Scribble"} style={{"transform": "translateX(-50%)"}}>
                <HiddenReveal variant="services-row" style={SERVICE_ROW_REVEAL_STYLE}>
                  <Scribble variant="type1" />
                </HiddenReveal>
              </div>
          ...
          <div className="ssr-variant todd-responsive-variant">
            <div className={"todd-services__tablet-8 todd-hide-desktop todd-hide-mobile"}>
              <div className={"todd-services__tablet-10 todd-services__tablet todd-services__tablet"} data-todd-name={"Tablet"}>
                <div className={"todd-services__icon-and-title"} data-todd-name={"Icon and Title"}>
                  <div className={"todd-services__tablet-11"} data-todd-component-type={"RichTextContainer"} style={{"--extracted-gdpscs": "var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237))", "--todd-link-text-color": "rgb(0, 153, 255)", "--todd-link-text-decoration": "underline", "transform": "none"}}>
                    <h1 dir={"auto"} className={"todd-text"} style={{"--font-selector": "RlI7SW50ZXJEaXNwbGF5LUJvbGQ=", "--todd-font-family": "\"Inter Display\", \"Inter Display Placeholder\", sans-serif", "--todd-font-size": "80px", "--todd-font-weight": "700", "--todd-letter-spacing": "-0.04em", "--todd-line-height": "90%", "--todd-text-alignment": "left", "--todd-text-color": "var(--extracted-gdpscs, var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237)))"}}>
          ...
          <div className="ssr-variant todd-responsive-variant">
            <div className={"todd-services__tablet-5 todd-hide-desktop todd-hide-tablet"}>
              <div className={"todd-services__tablet-10 todd-services__tablet todd-services__mobile"} data-todd-name={"Mobile"}>
                <div className={"todd-services__icon-and-title"} data-todd-name={"Icon and Title"}>
                  <div className={"todd-services__tablet-11"} data-todd-component-type={"RichTextContainer"} style={{"--extracted-gdpscs": "var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237))", "--todd-link-text-color": "rgb(0, 153, 255)", "--todd-link-text-decoration": "underline", "--extracted-a0htzi": "var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237))", "transform": "none"}}>
                    <h3 dir={"auto"} className={"todd-text"} style={{"--font-selector": "RlI7SW50ZXJEaXNwbGF5LUJvbGQ=", "--todd-font-family": "\"Inter Display\", \"Inter Display Placeholder\", sans-serif", "--todd-font-size": "32px", "--todd-font-weight": "700", "--todd-letter-spacing": "-0.04em", "--todd-line-height": "140%", "--todd-text-alignment": "left", "--todd-text-color": "var(--extracted-a0htzi, var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237)))"}}>
          ...
          <ServiceRowReveal rowIndex={0} className={"todd-services__tablet-4 todd-hide-tablet todd-hide-mobile"}>
            <ServiceRowLink
            ...
            >
              <div className={"todd-services__icon-and-title"} data-todd-name={"Icon and Title"}>
                ...
                <div className={"todd-services__tablet-11"} data-todd-component-type={"RichTextContainer"} style={{"--extracted-gdpscs": "var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237))", "--todd-link-text-color": "rgb(0, 153, 255)", "--todd-link-text-decoration": "underline", "transform": "none"}}>
                  <h1 dir={"auto"} className={"todd-text"} style={{"--font-selector": "RlI7SW50ZXJEaXNwbGF5LUJvbGQ=", "--todd-font-family": "\"Inter Display\", \"Inter Display Placeholder\", sans-serif", "--todd-font-size": "72px", "--todd-font-weight": "700", "--todd-letter-spacing": "-0.04em", "--todd-line-height": "90%", "--todd-text-alignment": "left", "--todd-text-color": "var(--extracted-gdpscs, var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237)))"}}>
          ...
          <div className={responsiveVisibleOnly("desktop")}>
            <ServiceRowReveal rowIndex={1} className={"todd-services__tablet-2"}>
              <ServiceRowLink
          ...
          <div className={responsiveVisibleOnly("tablet")}>
            <ServiceRowReveal rowIndex={1} className={"todd-services__tablet-2"}>
              <div className={"todd-services__tablet-10 todd-services__tablet todd-services__tablet"} data-todd-name={"Tablet"}>
                <div className={"todd-services__icon-and-title"} data-todd-name={"Icon and Title"}>
                  <div className={"todd-services__tablet-11"} data-todd-component-type={"RichTextContainer"} style={{"--extracted-gdpscs": "var(--token-d10d7d5c-1c4f-4f9d-802c-1a10cef2fa55, rgb(247, 244, 237))", "--todd-link-text-color": "rgb(0, 153, 255)", "--todd-link-text-decoration": "underline", "transform": "none"}}>
          ...
          <div className={responsiveVisibleOnly("desktop")}>
            <ServiceRowReveal rowIndex={2} className={"todd-services__tablet-7"}>
              <ServiceRowLink
          ...
          <div className={responsiveVisibleOnly("desktop")}>
            <ServiceRowReveal rowIndex={3} className={"todd-services__tablet-6"}>
              <ServiceRowLink
