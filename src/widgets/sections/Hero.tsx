...
export function Hero({ content }: { content: HeroContent }) {
  ...
  return (
    <section className={cn(TODD.hero.section, "todd-intro__wrapper-20")} data-todd-name="Hero">
      <div className={cn(TODD.hero.container, "todd-intro__wrapper-39")} data-todd-name="Container">
        ...
        <div className={responsiveHiddenOn("mobile")}>
          <Appear
            id="10mg3pr"
            className={cn(TODD.hero.mobileFallback, "todd-hero__mobile-illustration", "todd-hide-desktop", "todd-hide-tablet")}
